...
public class WebsecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/courses-management/course/{^[\\d]$}").hasAnyRole("ADMIN", "PROFESSOR")
                .antMatchers(HttpMethod.POST,"/courses-management/course").hasAnyRole("ADMIN", "PROFESSOR")
                .antMatchers(HttpMethod.PUT,"/courses-management/course").hasAnyRole("ADMIN", "PROFESSOR")
                .antMatchers(HttpMethod.DELETE,"/courses-management/course/{^[\\d]$}").hasAnyRole("ADMIN", "PROFESSOR")
                .antMatchers(HttpMethod.GET,"/courses-management/units/{^[\\d]$}").hasAnyRole("ADMIN", "PROFESSOR")
                .antMatchers(HttpMethod.GET,"/courses-management/unit/{^[\\d]$}").hasAnyRole("ADMIN", "PROFESSOR")
                ...
                .antMatchers(HttpMethod.GET,"/courses-management/task/{^[\\d]$}/{^[\\d]$}/{^[\\d]$}").hasAnyRole("ADMIN", "PROFESSOR")
                .antMatchers(HttpMethod.POST,"/courses-management/task/{^[\\d]$}/{^[\\d]$}").hasAnyRole("ADMIN", "PROFESSOR")
                .antMatchers(HttpMethod.PUT,"/courses-management/task/{^[\\d]$}/{^[\\d]$}/{^[\\d]$}").hasAnyRole("ADMIN", "PROFESSOR")
                .antMatchers(HttpMethod.DELETE,"/courses-management/task/{^[\\d]$}/{^[\\d]$}/{^[\\d]$}").hasAnyRole("ADMIN", "PROFESSOR")
